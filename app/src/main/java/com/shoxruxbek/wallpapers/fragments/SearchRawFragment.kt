...
import com.shoxruxbek.wallpapers.databinding.FragmentSearchRawBinding
 ...
 * Use the [SearchRawFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SearchRawFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    lateinit var binding: FragmentSearchRawBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSearchRawBinding.inflate(layoutInflater,container,false)

        val bundle = arguments
        val largeImageUrl = bundle!!.getString("wall")

        Glide.with(binding.root.context).load(largeImageUrl).into(binding.profile1);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(
                ...
                requestPermissions(
                    ...
                    RawFragment.REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION
                )
            }
        } else {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == RawFragment.REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION) {
